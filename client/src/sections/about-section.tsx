...
import { useLocation } from "wouter";  // Import wouter for navigation
...
const FeatureIcon = ({
  ...
  >
    <div
      className={`w-14 h-14 ${bgColor} rounded-xl shadow-sm flex items-center justify-center flex-shrink-0`}
    >
...
export function AboutSection() {
  const [, setLocation] = useLocation(); // Hook to navigate programmatically
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 items-center gap-12">
          <div className="lg:col-span-6 lg:col-start-1 order-2 lg:order-1">
            ...
            >
              ...
              >
                Confidante is a health and well-being startup dedicated to
                educating and supporting all aspects of health—beyond the
                physical. While many focus on physical health, we address the
                often-overlooked areas of mental, emotional, and social
                well-being.
              </motion.p>
              ...
              <motion.p
                ...
                className="text-lg text-neutral-700 leading-relaxed"
              >
                Our mission is to bring essential health education to schools and
                build an accessible platform where learning about these critical
                topics is easier than ever. We don't just start conversations, we
                turn them into real change.
              </motion.p>

              <motion.div
                variants={itemVariants}
                className="py-4 grid grid-cols-1 md:grid-cols-3 gap-4"
              >
                <FeatureIcon
                  icon="fas fa-brain"
                  text="Mental Health"
              ...
              <motion.div variants={itemVariants} className="pt-4">
                <Button
                  ...
                  onClick={() => setLocation("/about")} // Navigate to About page
                >
                  Learn more about us
